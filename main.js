...
global.reloadHandler = function () {
  ...
  conn.welcome = 'joder,que bueno verte por aca 🥺 @user!\nEspero te la pases súper 🌝@subject'
  conn.bye = 'Hasta que te fuiste😎@user!Da igual ya no te queríamos 👋'
  conn.spromote = '@Es el nuevo admin!'
